...
module.exports = {
  ally: {
    ...
    */
    google: {
      clientId:
        '899085435916-qprjg7phppua09ftfukoijm72u9tv456.apps.googleusercontent.com' /*Env.get('GOOGLE_CLIENT_ID')*/,
      clientSecret:
        'j2eexYJYkhDl2wAyxVyjnRcs' /*Env.get('GOOGLE_CLIENT_SECRET')*/,
